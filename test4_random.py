...
# =================================== Plot graph =======================================================================
#nx.draw(r4,with_labels=True)
#plt.show()

# =================================== Calculate centrality metrics =====================================================
#cm.clustering_coefficient_f(r4)
#cm.closeness_centrality_f(r4)
#cm.closeness_centrality_max_f(r4)
#cm.eigenvector_centrality_f(r4)
#cm.betweenness_centrality_f(r4)
#cm.average_degree_connectivity_f(r4)

# =================================== Independent Cascade Model ========================================================
model = ep.IndependentCascadesModel(r4)
...
#print(list4)
print("===============================================================================================================")
print("Total nodes infected: ", len(list4), "out of", len(nx.nodes(r4)))
print("Percentage  of total infected nodes with current seed set: ", (len(list4)/len(nx.nodes(r4)))*100,"%")
print("===============================================================================================================")
