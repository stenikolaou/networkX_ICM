...
# =================================== Plot graph =======================================================================
#nx.draw(r1,with_labels=True)
#plt.show()

# =================================== Calculate centrality metrics =====================================================
#cm.clustering_coefficient_f(r1)
#cm.closeness_centrality_f(r1)
#cm.closeness_centrality_max_f(r1)
#cm.eigenvector_centrality_f(r1)
#cm.betweenness_centrality_f(r1)
#cm.average_degree_connectivity_f(r1)

# =================================== Independent Cascade Model ========================================================
model = ep.IndependentCascadesModel(r1)
...
#print(list4)
print("===============================================================================================================")
print("Total nodes infected: ", len(list4), "out of", len(nx.nodes(r1)))
print("Percentage  of total infected nodes with current seed set: ", (len(list4)/len(nx.nodes(r1)))*100,"%")
print("===============================================================================================================")
